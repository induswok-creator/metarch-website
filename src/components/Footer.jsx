      ...
      <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1.3fr]">
          <div>
            ...
            <a
              href="https://wa.me/918369940174"
              target="_blank"
              rel="noopener noreferrer"
              className="group mt-4 inline-flex items-center gap-2.5 rounded-full border border-white/10 bg-white/5 px-4 py-2.5 text-xs text-zinc-400 transition-all duration-300 hover:-translate-y-0.5 hover:border-green-500/50 hover:bg-green-500/10 hover:text-zinc-100"
            >
              <svg viewBox="0 0 24 24" className="h-4 w-4 text-green-400" fill="currentColor" aria-hidden="true">
              ...
              <span>
                Website built by <span className="font-semibold text-zinc-100 transition-colors duration-300 group-hover:text-green-300">Noamaan Shaikh</span>
              </span>
            </a>
            <a
              href="https://wa.me/918369940174"
